...
set output 'gnuplot/after_error_correction.pdf'
set lmargin 3
set rmargin 2
set key top left
...
plot \
'gnuplot/after_error_correction.dat' using 1:2 with lines ls 1 title 'input', \
'gnuplot/after_error_correction.dat' using 1:7 with lines ls 2 title 'simulated', \
NaN notitle
